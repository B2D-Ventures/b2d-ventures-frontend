describe('template spec', () => {
  ...
  it('Create deal form', () => {
    ...
    cy.get('[data-testid="logo-input"]').selectFile('public/images/fitbake.png')
    cy.wait(100)
    cy.get('[data-testid="content-image-input"]').should('be.visible')
    cy.get('[data-testid="content-image-input"]').selectFile('public/images/fitbake-content.jpg')
    cy.wait(100)
    cy.get('[data-testid="deal-image-input"]').should('be.visible')
    cy.get('[data-testid="deal-image-input"]').selectFile('public/images/fitbake-deal.jpg')
    cy.wait(100)
    cy.get('[data-testid="private-data-input"]').should('be.visible')
    cy.get('[data-testid="private-data-input"]').selectFile('public/images/Document.pdf')
    cy.wait(100)
